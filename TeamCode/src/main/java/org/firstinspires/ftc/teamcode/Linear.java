...
public class Linear extends LinearOpMode {
    ...
    static final double DRIVE_GEAR_REDUCTION = 13.71;   //gear ratio

    static final double PULLY_DIAMETER = 1.575;    //

    static final double INCHES_PER_DEGREE = (11.0 / 90);
    static final double COUNTS_PER_INCH = (COUNTS_PER_MOTOR_REV * DRIVE_GEAR_REDUCTION) / (PULLY_DIAMETER * 3.1415);
